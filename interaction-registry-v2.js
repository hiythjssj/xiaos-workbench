/* 晓的工作台 V3.1：最终交互注册表。最后加载，只做动态转发、旧导航兼容与诊断。 */
(function(){
if(window.__xiaoFinalRegistryV31)return;window.__xiaoFinalRegistryV31=true;
window.XiaoActions={
...
/* index.html 仍保留旧底栏 go(this,'...')。统一转给 Router，避免重新打开混合“学习”页。 */
